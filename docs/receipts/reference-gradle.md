...
[Inspect the raw JSON receipt](reference-gradle.json) or [open the complete public workflow run](https://github.com/OthmaneBlial/rustdroid/actions/runs/33519017529).
